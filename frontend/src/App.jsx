...
return (
    <div className="min-h-screen bg-gray-50 pb-10">
        <nav className="bg-theme h-16 flex items-center justify-between px-8 shadow-md">
            <div className="text-white font-bold text-xl">АвиаСистема</div>
            <div className="flex items-center">
                ...
                {!user ? (
                    ...
                    <div className="flex items-center gap-4">
                        <span className="text-gray-300 text-sm border p-1 rounded border-gray-600">{user.roleName}</span>
                        <button onClick={handleLogout} className="text-accent hover:text-white transition font-medium">Выйти</button>
                    </div>
                )}
            </div>
        </nav>
